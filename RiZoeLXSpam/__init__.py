...
async def RiZoeLX():
    ...
    if STRING:
        ...
        try:
            ...
            await Riz(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING2:
        ...
        try:
            ...
            await Riz2.start()
            await Riz2(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING3:
        ...
        try:
            ...
            await  Riz3.start()
            await Riz3(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING4:
        ...
        try:
            ...
            await Riz4.start()
            await Riz4(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING5:
        ...
        try:
            ...
            await Riz5.start()
            await Riz5(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING6:
        ...
        try:
            ...
            await Riz6.start()
            await Riz6(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING7:
        ...
        try:
            ...
            await Riz7.start()
            await Riz7(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING8:
        ...
        try:
            ...
            await Riz8.start()
            await Riz8(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING9:
        ...
        try:
            ...
            await Riz9.start()
            await Riz9(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING10:
        ...
        try:
            ...
            await Riz10.start()
            await Riz10(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING11:
        ...
        try:
            ...
            await Riz11.start()
            await Riz11(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING12:
        ...
        try:
            ...
            await Riz12.start()
            await Riz12(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING13:
        ...
        try:
            ...
            await Riz13.start()
            await Riz13(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING14:
        ...
        try:
            ...
            await Riz14.start()
            await Riz14(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING15:
        ...
        try:
            ...
            await Riz15.start()
            await Riz15(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING16:
        ...
        try:
            ...
            await Riz16(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING17:
        ...
        try:
            ...
            await Riz17(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING18:
        ...
        try:
            ...
            await Riz18(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING19:
        ...
        try:
            ...
            await Riz19(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING20:
        ...
        try:
            ...
            await Riz20(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING21:
        ...
        try:
            ...
            await Riz21(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING22:
        ...
        try:
            ...
            await Riz22.start()
            await Riz22(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING23:
        ...
        try:
            ...
            await  Riz23.start()
            await Riz23(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING24:
        ...
        try:
            ...
            await Riz24.start()
            await Riz24(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING25:
        ...
        try:
            ...
            await Riz25.start()
            await Riz25(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING26:
        ...
        try:
            ...
            await Riz26.start()
            await Riz26(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING27:
        ...
        try:
            ...
            await Riz27.start()
            await Riz27(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING28:
        ...
        try:
            print("Booting Up The Client 18")
            await Riz28.start()
            await Riz28(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING29:
        ...
        try:
            ...
            await Riz29.start()
            await Riz29(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING30:
        ...
        try:
            ...
            await Riz30.start()
            await Riz30(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING31:
        ...
        try:
            ...
            await Riz31.start()
            await Riz31(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING32:
        ...
        try:
            print("Booting Up The Client 32")
            await Riz32.start()
            await Riz32(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING33:
        ...
        try:
            ...
            await Riz33.start()
            await Riz33(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING34:
        ...
        try:
            ...
            await Riz34.start()
            await Riz34(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING35:
        ...
        try:
            print("Booting Up The Client 35")
            await Riz35.start()
            await Riz35(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
    ...
    if STRING36:
        ...
        try:
            ...
            await Riz36(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING37:
        ...
        try:
            ...
            await Riz37(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING38:
        ...
        try:
            ...
            await Riz38(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING39:
        ...
        try:
            ...
            await Riz39(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING40:
        ...
        try:
            ...
            await Riz40(functions.channels.JoinChannelRequest(channel="@Harshu_xd"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
